...
\begin{frame}
	...
	\begin{itemize}
		\setlength{\itemsep}{\fill}
		\item \textcolor{cadmiumgreen}{$7-10$ times smaller charge loss due to radiation damage then in silicon}
...
\begin{frame}
	...
	\begin{minipage}{5.5cm}
		\begin{itemize}
			...
			\item large wafers (\SIrange{5}{6}{cm})
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item using pCVD diamonds and proof that they show no rate dependence 
	\end{itemize}
\end{frame}
